...
_P(NDPI_PROTOCOL_SKYPE_CALL_OUT),
_P(NDPI_PROTOCOL_MUSICALLY),
_P(NDPI_PROTOCOL_MEMCACHED),
_P(NDPI_PROTOCOL_FREE_41),
_P(NDPI_PROTOCOL_FREE_42),
_P(NDPI_PROTOCOL_FREE_43),
_P(NDPI_PROTOCOL_FREE_44),
_P(NDPI_PROTOCOL_FREE_45),
_P(NDPI_PROTOCOL_FREE_46),
_P(NDPI_PROTOCOL_XBOX),
_P(NDPI_PROTOCOL_QQ),
_P(NDPI_PROTOCOL_SKYPE_CALL_IN),
...
_P(NDPI_PROTOCOL_HTTP_ACTIVESYNC),
...
_P(NDPI_PROTOCOL_FREE_205),
_P(NDPI_PROTOCOL_VIDTO),
